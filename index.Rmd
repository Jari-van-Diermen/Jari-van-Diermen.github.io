...
I am an enthusiastic aspiring bioinformatician with a strong interest in bioinformatics and computational data analysis. I am particularly motivated by the development and application of robust analysis strategies and the integration of large-scale multi-omics datasets. The Omics-field is rapidly changing, with a multitude of methods being developed that allow the exploration of complex biological systems at an unprecedented scale. I am eager to further develop my skills in building, analyzing, integrating, visualizing, and interpreting multi-omics data, supported by my extensive biological background, which allows me to bridge computational methods and biological insight.
...
- Python and R Analysis of single-cell sequencing data from multimodal epigenetic
methods (i.e. [scDam&T](https://pmc.ncbi.nlm.nih.gov/articles/PMC6609448/),
[Dam&ChiC](https://pubmed.ncbi.nlm.nih.gov/40640501/)).
  - Cell Trajectory/pseudotime analysis.
  - Dataset integration / reference mapping.
  - Lamina associated domain (LAD) calling.
  - Differential (i.e. cell-type specific) LAD detection.
  - single-cell differential gene expression analysis.
  - Correlating transcriptomic changes with nuclear lamina association.
- Using public epigenetic sequencing data (i.e. ChIC, CUT&RUN, ChIP-seq).
- Building single-cell sequencing preprocessing pipelines with snakemake, like
the [sciT-snakemake pipeline](https://github.com/Jari-van-Diermen/SciT_snakemake).
- Building R packages, like the
[LoadSciLooms](https://github.com/Jari-van-Diermen/LoadSciLooms) R package.
- Presenting data
- Attending epigenetic and bioinformatics symposia/conferences
