...
I am an early-career computational biologist with a strong interest in developing solutions for the processing, storage, and visualization of big data. I have experience building computational pipelines for evolutionary analysis as well as for preprocessing various types of single-cell sequencing data. Driven by my interest in the technical aspects of data processing, I am eager to further develop my skills in data engineering and analysis, both within and beyond the biological domain.
...
- Python and R Analysis of in-house and public single-cell sequencing data from multimodal epigenetic
...
- Continued experience with High Performance Computing (HPC) environments
